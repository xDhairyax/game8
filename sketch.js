...
function setup(){
  createCanvas(screenWidth-20,screenHeight-20);

  ground=createSprite(screenWidth/2,screenHeight-200,screenWidth,20);
  ground.visible=false;
  

  var ground1=createSprite(screenWidth/2,screenHeight-200,screenWidth,20);
  ground1.visible=false;

  player=createSprite(100,screenHeight-250,50,50);
  player.addImage("player2",playerImg);
  player.scale=0.25;

player1=createSprite(300,screenHeight-250,50,50);
player1.addImage("player3",player1Img);
//player1.scale=;
player1.visible=false;

 upArrow=createButton("JUMP");
upArrow.position(screenWidth-400,screenHeight-300);
...
downArrow.position(screenWidth-400,screenHeight-250);
downArrow.mousePressed(()=>{
 ...
 rightArrow=createButton("RIGHT");
  rightArrow.position(screenWidth-350,screenHeight-270);
  ...
  leftArrow.position(screenWidth-450,screenHeight-270);
  ...
  shootBullet.position(screenWidth-400,screenHeight-350);
  ...
  boss=createSprite(screenWidth-300,screenHeight-500,50,50);
  boss.addImage("bossIMAGE",boss1);

  boss4=createSprite(400,400,50,50);
  boss4.visible=false;
...
downArrow.mousePressed(()=>{
 ...
 rightArrow=createButton("RIGHT");
  ...
  textSize(50);
  stroke(255);
  text("KILLS:"+kills,screenWidth/2,200);
...
function spawnEnemy(){
if(frameCount % 50===0){
var enemy=createSprite(screenWidth,screenHeight-250,50,50);
...
function createBullet(){
  var bullet=createSprite(100,screenHeight-250,50,50);
